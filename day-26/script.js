...
// Print an info to console, identical to console.log
...
// console.log(message.slice(3, 15));
...
// Split property
let message = "Hello Brother, How are You?";
// string ko letters me split kr ne ke liye
// console.log(message.split(''));
// string ko sare o ki jagah se split krna
// console.log(message.split('o'));
// string ko o se split krke sabko join kr dena
